...
from src.masonite_2fa import TwoFAMiddleware, ForceTwoFAMiddleware
...
class Kernel:
    ...
    route_middleware = {
        ...
        "auth": [AuthenticationMiddleware, TwoFAMiddleware],
        "force_2fa": [ForceTwoFAMiddleware],
    }
    ...
    def register_configurations(self):
        ...
        self.application.bind(
            "controllers.location", "tests/integrations/app/controllers"
        )
        ...
        self.application.bind(
            "validation.location", "tests/integrations/app/validation"
        )
        self.application.bind(
            "notifications.location", "tests/integrations/app/notifications"
        )
        ...
        self.application.bind(
            "observers.location", "tests/integrations/app/models/observers"
        )
