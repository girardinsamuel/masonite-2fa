...
setup(
    ...
    packages=[
        "masonite_2fa",
        "masonite_2fa.providers",
        "masonite_2fa.config",
    ],
    package_dir={"": "src"},
    description="Masonite Two-Factor authentication package supporting HOTP and TOTP algorithms.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    # The project's main homepage.
    url="https://github.com/girardinsamuel/masonite-2fa",
    # Author details
