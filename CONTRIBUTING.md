...
1. Fork the `https://github.com/girardinsamuel/masonite-2fa` repo.
2. Clone that repo into your computer: `git clone http://github.com/your-username/2fa.git`.
